...
dlt.1<- c(0.20, 0.35, 0.45, 0.50, 0.55)
dlt.0<- c(0.35, 0.45, 0.50, 0.55, 0.60)
...
for(i in 1:n.sim){
  ...
  write.csv(efficacy.estimate, paste0("/home/ealger/pro_add/results/hypothetical.",general_list[[15]],".partial/hypothetical.sc",scenario,".", mtd,".60.e.csv"))
  write.csv(efficacy.estimate.bb, paste0("/home/ealger/pro_add/results/hypothetical.",general_list[[15]],".partial/hypothetical.sc",scenario,".", mtd,".60.e.bb.csv"))
  write.csv(pro.estimate, paste0("/home/ealger/pro_add/results/hypothetical.",general_list[[15]],".partial/hypothetical.sc",scenario,".", mtd,".60.p.csv"))
  write.csv(loss, paste0("/home/ealger/pro_add/results/hypothetical.",general_list[[15]],".partial/hypothetical.sc",scenario,".", mtd,".60.l.csv"))
  write.csv(loss.bb, paste0("/home/ealger/pro_add/results/hypothetical.",general_list[[15]],".partial/hypothetical.sc",scenario,".", mtd,".60.l.bb.csv"))
  write.csv(n.patient.allocated, paste0("/home/ealger/pro_add/results/hypothetical.",general_list[[15]],".partial/hypothetical.sc",scenario,".", mtd,".60.n.csv"))
  write.csv(admiss, paste0("/home/ealger/pro_add/results/hypothetical.",general_list[[15]],".partial/hypothetical.sc",scenario,".", mtd,".60.a.csv"))
  write.csv(mtd.rec, paste0("/home/ealger/pro_add/results/hypothetical.",general_list[[15]],".partial/hypothetical.sc",scenario,".", mtd,".60.mr.csv"))
  write.csv(mtd.prob, paste0("/home/ealger/pro_add/results/hypothetical.",general_list[[15]],".partial/hypothetical.sc",scenario,".", mtd,".60.mp.csv"))
  write.csv(ncens, paste0("/home/ealger/pro_add/results/hypothetical.",general_list[[15]],".partial/hypothetical.sc",scenario,".", mtd,".60.ncens.csv"))
  write.csv(ndlt, paste0("/home/ealger/pro_add/results/hypothetical.",general_list[[15]],".partial/hypothetical.sc",scenario,".", mtd,".60.ndlt.csv"))
  write.csv(futility1, paste0("/home/ealger/pro_add/results/hypothetical.",general_list[[15]],".partial/hypothetical.sc",scenario,".", mtd,".60.futility1.csv"))
  write.csv(futility2, paste0("/home/ealger/pro_add/results/hypothetical.",general_list[[15]],".partial/hypothetical.sc",scenario,".", mtd,".60.futility2.csv"))
  write.csv(futilityfinal, paste0("/home/ealger/pro_add/results/hypothetical.",general_list[[15]],".partial/hypothetical.sc",scenario,".", mtd,".60.futilityfinal.csv"))
  write.csv(safetyfinal, paste0("/home/ealger/pro_add/results/hypothetical.",general_list[[15]],".partial/hypothetical.sc",scenario,".", mtd,".60.safetyfinal.csv"))
  write.csv(sample_size, paste0("/home/ealger/pro_add/results/hypothetical.",general_list[[15]],".partial/hypothetical.sc",scenario,".", mtd,".60.samplesize.csv"))
}

saveRDS(general_list, file = paste0("/home/ealger/pro_add/results/hypothetical.",general_list[[15]],".partial/hypothetical.general_list"))
saveRDS(boin_list, file = paste0("/home/ealger/pro_add/results/hypothetical.",general_list[[15]],".partial/hypothetical.boin_list"))
saveRDS(pro_list, file = paste0("/home/ealger/pro_add/results/hypothetical.",general_list[[15]],".partial/hypothetical.pro_list"))
saveRDS(eff_list, file = paste0("/home/ealger/pro_add/results/hypothetical.",general_list[[15]],".partial/hypothetical.eff_list"))
